 ...
 @section('contenido')
<div class="row"><button class="btn btn-success" onclick="window.location.assign('/admin/Proveedores/create')">Agregar</button></div>
 <table class="table table-bordered table-striped table-sm">
    ...
    <div class="row">{{ $ProveedoresList->links() }}</div>
    <script>

    function deleteProveedores(id){
            Swal.fire({
                title: 'Seguro de borrar proveedores?',
