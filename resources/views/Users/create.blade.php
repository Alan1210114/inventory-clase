...
@endif
<form class= "form-horizontal" action="{{ route('users.create') }}" method="POST" method="POST" enctype="multipart/form-data">
@csrf
<div class="card-body">
<div class="form-group">
<label for="name" class="col-sm-4 control-label">name</label>
<input type="text" maxlength="400" name="name" id="name"  class="form-control" placeholder="name">
@if($errors->has('name'))
...
<input type="text" maxlength="600" name="email" id="email"  class="form-control" placeholder="email">
@if($errors->has('email'))
...
<input type="text" maxlength="20" name="idRole" id="idRole"  class="form-control" placeholder="idRole">
