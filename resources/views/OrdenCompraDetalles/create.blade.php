...
<h2 class="">Nuevo OrdenCompraDetalles</h2>
</div>
...
@endif
<form class= "form-horizontal" action="{{ route('OrdenCompraDetalles.create') }}" method="POST" method="POST" enctype="multipart/form-data">
@csrf
<div class="card-body">
<div class="form-group">
<label for="orden_compra_id" class="col-sm-4 control-label">orden_compra_id</label>
<input type="text" maxlength="20" name="orden_compra_id" id="orden_compra_id"  class="form-control" placeholder="orden_compra_id">
