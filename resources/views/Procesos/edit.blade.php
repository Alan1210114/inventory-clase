...
@endif
<form class= "form-horizontal" action="{{ route('procesos.update',$Procesos->id) }}" method="POST" enctype="multipart/form-data">
@csrf
@method('PATCH')
<div class="card-body">
<div class="form-group">
<label for="fecha_hora_inicio" class="col-sm-4 control-label">fecha_hora_inicio</label>
<input type="text" maxlength="19" name="fecha_hora_inicio" id="fecha_hora_inicio" value="{{ $Procesos->fecha_hora_inicio }}" class="form-control" placeholder="fecha_hora_inicio">
...
<input type="text" maxlength="200" name="tipo_proceso" id="tipo_proceso" value="{{ $Procesos->tipo_proceso }}" class="form-control" placeholder="tipo_proceso">
...
<input type="text" maxlength="20" name="operador_id" id="operador_id" value="{{ $Procesos->operador_id }}" class="form-control" placeholder="operador_id">
...
<input type="text" maxlength="20" name="material_id" id="material_id" value="{{ $Procesos->material_id }}" class="form-control" placeholder="material_id">
...
<input type="text" maxlength="20" name="producto_resultante" id="producto_resultante" value="{{ $Procesos->producto_resultante }}" class="form-control" placeholder="producto_resultante">
...
<input type="text" maxlength="20" name="tipo_pieza_id" id="tipo_pieza_id" value="{{ $Procesos->tipo_pieza_id }}" class="form-control" placeholder="tipo_pieza_id">
...
<input type="text" maxlength="19" name="fecha_hora_terminacion" id="fecha_hora_terminacion" value="{{ $Procesos->fecha_hora_terminacion }}" class="form-control" placeholder="fecha_hora_terminacion">
