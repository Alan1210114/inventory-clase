...
<h2 class="">Editar departamentos</h2>
</div>
...
@endif
<form class= "form-horizontal" action="{{ route('departamentos.update',$Departamentos->id) }}" method="POST" enctype="multipart/form-data">
@csrf
@method('PATCH')
<div class="card-body">
<div class="form-group">
<label for="nombre_departamento" class="col-sm-4 control-label">nombre_departamento</label>
<input type="text" maxlength="400" name="nombre_departamento" id="nombre_departamento" value="{{ $Departamentos->nombre_departamento }}" class="form-control" placeholder="nombre_departamento">
