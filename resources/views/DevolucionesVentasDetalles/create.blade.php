...
<h2 class="">Nuevo DevolucionesVentasDetalles</h2>
</div>
...
@endif
<form class= "form-horizontal" action="{{ route('DevolucionesVentasDetalles.create') }}" method="POST" method="POST" enctype="multipart/form-data">
@csrf
<div class="card-body">
<div class="form-group">
<label for="devoluciones_venta_id" class="col-sm-4 control-label">devoluciones_venta_id</label>
<input type="text" maxlength="20" name="devoluciones_venta_id" id="devoluciones_venta_id"  class="form-control" placeholder="devoluciones_venta_id">
...
<input type="text" maxlength="20" name="cantidad" id="cantidad"  class="form-control" placeholder="cantidad">
