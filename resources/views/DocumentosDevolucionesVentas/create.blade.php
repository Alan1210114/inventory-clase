...
<h2 class="">Nuevo DocumentosDevolucionesVentas</h2>
</div>
...
@endif
<form class= "form-horizontal" action="{{ route('DocumentosDevolucionesVentas.create') }}" method="POST" method="POST" enctype="multipart/form-data">
@csrf
<div class="card-body">
...
<input type="text" maxlength="20" name="devolucion_ventas_id" id="devolucion_ventas_id"  class="form-control" placeholder="devolucion_ventas_id">
