...
<h2 class="">Nuevo FacturasClientes</h2>
</div>
...
@endif
<form class= "form-horizontal" action="{{ route('facturasClientes.create') }}" method="POST" method="POST" enctype="multipart/form-data">
@csrf
<div class="card-body">
...
<input type="text" maxlength="11" name="status" id="status"  class="form-control" placeholder="status">
