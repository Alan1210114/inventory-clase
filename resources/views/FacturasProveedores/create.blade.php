...
<h2 class="">Nuevo FacturasProveedores</h2>
</div>
...
@endif
<form class= "form-horizontal" action="{{ route('FacturasProveedores.create') }}" method="POST" method="POST" enctype="multipart/form-data">
@csrf
<div class="card-body">
