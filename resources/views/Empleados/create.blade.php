...
@endif
<form class= "form-horizontal" action="{{ route('empleados.create') }}" method="POST" method="POST" enctype="multipart/form-data">
@csrf
<div class="card-body">
<div class="form-group">
<label for="nombre" class="col-sm-4 control-label">nombre</label>
<input type="text" maxlength="200" name="nombre" id="nombre"  class="form-control" placeholder="nombre">
...
<input type="text" maxlength="200" name="apellido_paterno" id="apellido_paterno"  class="form-control" placeholder="apellido_paterno">
...
<input type="text" maxlength="200" name="apellido_materno" id="apellido_materno"  class="form-control" placeholder="apellido_materno">
...
<input type="text" maxlength="20" name="departamento_id" id="departamento_id"  class="form-control" placeholder="departamento_id">
...
<input type="text" maxlength="80" name="curp" id="curp"  class="form-control" placeholder="curp">
@if($errors->has('curp'))
