...
<h2 class="">Nuevo FacturasClientesDetalles</h2>
</div>
...
@endif
<form class= "form-horizontal" action="{{ route('FacturasClientesDetalles.create') }}" method="POST" method="POST" enctype="multipart/form-data">
@csrf
<div class="card-body">
<div class="form-group">
<label for="facturas_clientes_id" class="col-sm-4 control-label">facturas_clientes_id</label>
<input type="text" maxlength="20" name="facturas_clientes_id" id="facturas_clientes_id"  class="form-control" placeholder="facturas_clientes_id">
